...
def train_predict(train_tweet, train_target, train_sentiment, test_tweet, test_target, test_sentiment, wordembedding, train_snippet, test_snippet):
	...
	print 'save feature to bos_feature...'
	with open('bos_feature', 'wb') as f:
		pickle.dump(vec, f)
	...
	print 'save feature to boe_feature...'
	with open('boe_feature', 'wb') as f:
		pickle.dump(vec, f)
	...
	print 'save model to ETR_model...'
	with open('ETR_model', 'wb') as f:
		pickle.dump(clf, f)
